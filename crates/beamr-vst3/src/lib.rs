//! # beamr-vst3
//!
//! VST3 implementation layer for the BEAMR framework.
//!
//! This crate provides the VST3 interface implementations that wrap `beamr-core` traits
...
//!
//! ```text
//! User Plugin (implements beamr_core::Plugin)
//!        ↓
...
//! ## Usage
//!
//! 1. Implement `beamr_core::Plugin` for your plugin type
//! 2. Use `export_vst3!` macro to generate entry points
//!
//! ```rust,ignore
//! use beamr_core::{Plugin, AudioProcessor, AudioBuffer, Parameters, ParamInfo};
//! use beamr_vst3::{export_vst3, Vst3Processor, PluginConfig, vst3};
//!
//! // Define your plugin
